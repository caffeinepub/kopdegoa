    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-primary/90 via-accent-red/80 to-primary/90" }),
...
function Products() {
  const categories = [
    ...
    },
    {
      ...
      description: "Traditional Goan cashew feni, coconut feni, and locally crafted spirits — the soul of Goa in every pour",
      color: "text-primary",
      bgColor: "bg-primary/10"
    },
    {
