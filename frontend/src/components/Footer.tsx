...
export function Footer() {
  const handleRequestChangesClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-sm text-primary-foreground/90">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:9604456789" className="hover:text-white transition-colors">
                9604456789
              </a>
            </div>
          </div>
          ...
          <div className="text-sm">
            <a
              ...
              className="text-primary-foreground/90 hover:text-white transition-colors underline"
            >
              Request Changes
            </a>
          </div>
          ...
          <div className="text-center text-xs text-primary-foreground/60 max-w-2xl">
            <p>
              Please drink responsibly. Must be of legal drinking age to purchase alcohol.
            </p>
          </div>
        </div>
      </div>
